...
class WithdrawPolicy extends StatefulWidget {
  @override
  _WithdrawPolicyState createState() => _WithdrawPolicyState();
}

class _WithdrawPolicyState extends State<WithdrawPolicy> {
  String _description = 'Loading...';

  Future<void> _fetchData() async {
    final response = await http.get(Uri.parse('https://dsrummy.whitelabelexchanges.com/v1/user/getPolicy'));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
        title: AppText('Withdrawal Policy',
          fontSize: 18,
