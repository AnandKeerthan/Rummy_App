...
//     final response = await http.get(Uri.parse('https://dsrummy.whitelabelexchanges.com/v1/user/getTerms'));
//
...
//         Container(
//
//           decoration: BoxDecoration(border: Border.all(color: ColorConstant.apptheme,width: 2),
//           borderRadius: BorderRadius.circular(10)),
//
//             child: Padding(
//               padding: const EdgeInsets.all(8.0),
//               child: AppText(_description, fontSize: 16,
//                 fontWeight: FontWeight.w500,),
//             )):
